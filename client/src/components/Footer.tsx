export default function Footer() {
  return (
    <footer className="mt-12 pt-6 border-t border-slate-800/60 text-center text-sm text-slate-500">
      <div className="space-y-2">
        <div className="flex items-center justify-center gap-4 flex-wrap">
          <a
            href="https://github.com/johnkord/sendie"
            target="_blank"
          ...
          <span className="inline-flex items-center gap-1">
            Discord ID of maintainer:{' '}
            <span className="text-purple-400">curlyquote</span>
          </span>
        </div>
