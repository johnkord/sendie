...
describe('appStore', () => {
  ...
  describe('connection state', () => {
    it('should have initial disconnected state', () => {
      ...
      expect(state.connection.maxPeers).toBe(10);
      expect(state.connection.localFriendlyName).toBeNull();
    });
    ...
    it('should update connection state partially', () => {
      ...
      expect(state.connection.maxPeers).toBe(10); // Should remain unchanged
    });
